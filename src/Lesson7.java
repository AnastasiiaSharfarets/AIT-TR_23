...
public class Lesson7 {
    public static void main(String[] args) {
        ...
        \\ - обратный слеш
        \n - новая строка
        \t -табуляция (\t и является аналогом четырех пробелов. Однако, если длина строки, состоящая из
        четырех пробелов будет равна длине четырех символов, то длина строки с символом табуляции будет равна одному.)

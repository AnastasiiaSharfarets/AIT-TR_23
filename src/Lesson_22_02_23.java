...
public class Lesson_22_02_23 {
    ...
    public static void currencyConvertor(double userMoneyAmount, int choice) {
        switch (choice) {
            ...
            case 1:
                double result = userMoneyAmount * 0.94;
                System.out.println("You receive");
                System.out.println(result + " EUR");
                break;
            case 2:
                result = userMoneyAmount * 0.83;
                System.out.println("You receive");
                System.out.println(result + " GBP");
                break;
            case 3:
                result = userMoneyAmount * 75.37;
                System.out.println("You receive");
                System.out.println(result + " RUB");
                break;
            case 4:
                result = userMoneyAmount * 1.05;
                System.out.println("You receive");
                System.out.println(result + " USD");
                break;
            case 5:
                result = userMoneyAmount * 0.87;
                System.out.println("You receive");
                System.out.println(result + " GBP");
                break;
            case 6:
                result = userMoneyAmount * 79.98;
                System.out.println("You receive");
                System.out.println(result + " RUB");
            case 7:
